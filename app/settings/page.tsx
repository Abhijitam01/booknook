        ...
        <TabsContent value="profile" className="mt-6 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set your reading goals and track your progress</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="reading-goal">Annual Reading Goal</Label>
                <div className="flex items-center gap-2">
                  <Input id="reading-goal" type="number" defaultValue="24" className="w-24" />
                  <span>books per year</span>
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="favorite-genre">Favorite Genre</Label>
                <Select defaultValue="science-fiction">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Connect your GitHub account</div>
                  </div>
                </div>
                <Button variant="outline">Connect</Button>
              </div>
        ...
        <TabsContent value="preferences" className="mt-6 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Customize how BookNook looks on your device</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Get reminders to continue reading your books</div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium">New Book Recommendations</div>
                  <div className="text-sm text-muted-foreground">
                    Receive recommendations based on your reading history
                  </div>
                </div>
                <Switch id="book-recommendations" defaultChecked />
              </div>
            </CardContent>
            <CardFooter>
              <Button>Save Preferences</Button>
